...
func RegisterRoutes(r *mux.Router) {
	...
	user.HandleFunc("/password", handlers.ChangePasswordHandler).Methods("PATCH")
	...
	admin.HandleFunc("/user/{id}/password", admin_mgt.AdminResetPasswordHandler).Methods("PATCH")
